...
$query="insert into  registration(sscper,sscschool,sscyear, hscper, hsccollege, hscyear,yeargap, year,sem,mentor,hostelstatus,bday,cgpa,course,prnno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('isiisissisisissssssisississsisssi',$sscper, $sscschool, $sscyear, $hscper, $hsccollege, $hscyear,$yeargap,$year,$sem,$mentor,$hostelstatus,$bday,$cgpa,$course,$prnno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="left">Profile Already Registered</h3>
				<?php }
				else{
							echo "";
							}			
...
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">Past Acadamic info </h4> </label>
</div>
...
<div class="col-sm-8">
<input type="text" name="sscper" id="sscper"  class="form-control" >
</div>
</div>


<div class="form-group">
<label class="col-sm-2 control-label">SSC School </label>
<div class="col-sm-8">
<input type="text" name="sscschool" id="sscschool"  class="form-control" >
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">SSC Passing Year</label>
<div class="col-sm-8">
<select name="sscyear" id="sscyear" class="form-control">
...
<div class="form-group">
<label class="col-sm-2 control-label">HSC / Dioloma percentage</label>
<div class="col-sm-8">
<input type="text" name="hscper" id="hscper"  class="form-control" >
</div>
</div>


<div class="form-group">
<label class="col-sm-2 control-label">HSC / Diploma College </label>
<div class="col-sm-8">
<input type="text" name="hsccollege" id="hsccollege"  class="form-control" >
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">HSC Passing Year</label>
<div class="col-sm-8">
<select name="hscyear" id="hscyear" class="form-control">
<option value="">Select Passing Year</option>
<option value="2015">2015</option>
<option value="2016">2016</option>
<option value="2017">2017</option>
...
<div class="form-group">
<label class="col-sm-2 control-label">Year Gap</label>
<div class="col-sm-8">
<select name="yeargap" id="yeargap" class="form-control">
<option value="">Having Year Gap ?</option>
...
<div class="form-group">
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">Acadamic info </h4> </label>
</div>
...
<option value="">Select ongoing Year</option>
<option value="1">Fisr Year</option>
...
<div class="form-group">
<label class="col-sm-2 control-label">Current Sem</label>
<div class="col-sm-8">
<select name="sem" id="sem" class="form-control">
<option value="">Select ongoing semister</option>
...
<div class="form-group">
<label class="col-sm-2 control-label">Name of Mentor</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Hostel Status</label>
<div class="col-sm-8">
<input type="radio" value="0" name="hostelstatus" checked="checked"> Hostelier
<input type="radio" value="1" name="hostelstatus"> Day Scholer (up-Down form home)
</div>
</div>	

<div class="form-group">
<label class="col-sm-2 control-label">Birthaday </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Overall CGPA</label>
<div class="col-sm-8">
<input type="text" name="cgpa" id="cgpa"  class="result form-control" >
</div>
</div>
